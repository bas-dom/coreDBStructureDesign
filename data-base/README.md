...
|8|rolerightwritepoint|text|0|是|否|????
|9|roleright1|text|0|是|否|???
|10|roleright2|text|0|是|否|???
|11|roleright3|text|0|是|否|???
|12|roleright4|text|0|是|否|???
|13|roleright5|text|0|是|否|???
...
|10|fileblob|longblob|0|是|否|文件块？？
